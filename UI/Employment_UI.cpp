		...
		if (CInput::GetKeyTrigger(VK_SPACE) || CInputController::GetKeyTrigger(XINPUT_GAMEPAD_A))
		{
			...
			case Swordman:
				if (0 < WorldManager::GetSoldierPoint())
				{
					...
					member->m_Character->SetName(std::string("åïém"));
			...
			case Archer:
				...
				/*if (2 < WorldManager::GetSoldierPoint())
				{
					...
					member->m_Exp = 0;
					member->m_NextExp = FIRST_LEVELUP;
					member->m_Character->SetName(std::string("ã|égÇ¢"));
			...
			case Sorcerer:
				...
				/*if (2 < WorldManager::GetSoldierPoint())
				{
					...
					member->m_Exp = 0;
					member->m_NextExp = FIRST_LEVELUP;
					member->m_Character->SetName(std::string("ñÇèpét"));
			...
			case Healer:
				...
				/*if (2 < WorldManager::GetSoldierPoint())
				{
					...
					member->m_Exp = 0;
					member->m_NextExp = FIRST_LEVELUP;
					member->m_Character->SetName(std::string("èCìπém"));
			...
			case Lancer:
				if (3 <= WorldManager::GetSoldierPoint())
				{
					...
					member->m_Exp = 0;
					member->m_NextExp = FIRST_LEVELUP;
					member->m_Character->SetName(std::string("ëÑï∫"));
